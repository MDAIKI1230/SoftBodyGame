...
std::unique_ptr<ObjectBase> ObjectFactory::CreateDebugBox(WorldStorage* world, const EntityID& _entity)
{
	return std::make_unique<DebugBox>(world, _entity);
}

std::unique_ptr<ObjectBase> ObjectFactory::CreateSphereBox(WorldStorage* world, const EntityID& _entity)
{
