	...
	ObjectBase{ _world,_entity }
{
	...
	ResourceManager::LoadModel("M_001_player_095_01_no_sword_walk_.mv1");
	RendererComponent* renderer{ AddComponent<RendererComponent>(ResourceManager::GetModel("M_001_player_095_01_no_sword_walk_.mv1")) };
